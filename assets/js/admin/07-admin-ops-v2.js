    ...
    async function paymentAction(type){
        ...
        try{
            if(type==="approve"){
                ...
                await window.GOXION_FINANCIAL_ACTIONS.registerPartialPayment({clienteId:c._id,saldoRestante:amount,periodoEsperado:String(c.periodo_pendiente||c.estado_cuenta?.periodo||"").slice(0,7),notas:msg});
